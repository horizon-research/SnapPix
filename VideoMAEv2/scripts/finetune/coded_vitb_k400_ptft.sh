...
export MODEL_PATH='local/coded_vitb_pt_decor/checkpoint-299.pth'
...
OUTPUT_DIR="local/k400/vitb_"$CODED_TYPE"_"$CROSS_NAME"_k400_ptft_no_clip"
...
python3 -m torch.distributed.launch --nproc_per_node=2 \
        ...
        --model coded_vit_base_patch8_112 \
        --finetune ${MODEL_PATH} \

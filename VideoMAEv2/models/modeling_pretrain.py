...
def pretrain_videomae_small_patch8_112(pretrained=False, **kwargs):
    model = PretrainVisionTransformer(
        ...
        encoder_num_heads=6,
        encoder_num_classes=0,
        decoder_num_classes=64,  # 16 * 16 * 3 * 2
...
@register_model
def pretrain_videomae_super_tiny_patch8_112(pretrained=False, **kwargs):
    model = PretrainVisionTransformer(
        img_size=112,
        patch_size=8,
        ...
        encoder_num_heads=2,
        encoder_num_classes=0,
        decoder_num_classes=128,  # 8 * 8 * 1 * 2
...
@register_model
def pretrain_videomae_base_patch8_112(pretrained=False, **kwargs):
    model = PretrainVisionTransformer(
        img_size=112,
        patch_size=8,
        encoder_embed_dim=768,

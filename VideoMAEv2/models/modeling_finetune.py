...
# Ours =================================================================================================
@register_model
def vit_super_tiny_patch8_112(pretrained=False, **kwargs):
...
@register_model
def vit_tiny_patch8_112(pretrained=False, **kwargs):
    model = VisionTransformer(
        patch_size=8,
        embed_dim=192,
        depth=12,
...
@register_model
def vit_small_patch8_112(pretrained=False, **kwargs):
    model = VisionTransformer(
        patch_size=8,
        embed_dim=384,
        depth=12,
...
@register_model
def vit_large_patch8_112(pretrained=False, **kwargs):
    model = VisionTransformer(
        patch_size=8,
        embed_dim=1024,
        depth=24,
...
@register_model
def vit_base_patch8_112(pretrained=False, **kwargs):
    model = VisionTransformer(
        patch_size=8,
        embed_dim=768,
        depth=12,

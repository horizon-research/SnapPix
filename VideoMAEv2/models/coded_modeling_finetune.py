...
class CodedVisionTransformer(nn.Module):
    ...
    def no_weight_decay(self):
        no_decay_params = {'pos_embed', 'cls_token'}
...
# Ours =================================================================================================
@register_model
def coded_vit_small_patch8_112(pretrained=False, **kwargs):
...
@register_model
def coded_vit_base_patch8_112(pretrained=False, **kwargs):
    model = CodedVisionTransformer(
        patch_size=8,
        embed_dim=768,
        depth=12,
